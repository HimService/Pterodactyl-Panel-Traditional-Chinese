            ...
            <form action="{{ route('admin.servers.view.details', $server->id) }}" method="POST">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <p class="text-muted small">留空則不為此伺服器分配外部識別碼。外部 ID 對於此伺服器應是唯一的，且不得被任何其他伺服器使用。</p>
                    </div>
                    <div class="form-group">
                        ...
                        <p class="text-muted small">您可以通過將此欄位更改為與此系統上其他用途匹配的電子郵件來更改此伺服器的擁有者。如果您這樣做，將自動產生一個新的節點安全令牌。</p>
                    </div>
                    <div class="form-group">
                ...
                <div class="box-footer">
                    {!! csrf_field() !!}
                    {!! method_field('PATCH') !!}
                    <input type="submit" class="btn btn-sm btn-primary" value="更新基本資訊
" />
                </div>
            </form>
        </div>
