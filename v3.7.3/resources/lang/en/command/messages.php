...
return [
    'location' => [
        'no_location_found' => '找不到符合所提供短代碼的記錄。',
        'ask_short' => '地區短代碼',
        'ask_long' => '地區描述',
        'created' => '已成功建立新地區 (:name)，ID 為 :id。',
        'deleted' => '已成功刪除請求的地區。',
    ],
    'user' => [
        ...
        'multiple_found' => '為所提供的使用者找到多個帳戶，由於 --no-interaction 旗標，無法刪除使用者。',
        'ask_admin' => '此使用者是管理員嗎？',
        'ask_email' => '電子郵件地址',
        'ask_username' => '使用者名稱',
        'ask_name_first' => '名字',
        'ask_name_last' => '姓氏',
        'ask_password' => '密碼',
        'ask_password_tip' => '如果您想建立一個帳戶，並將隨機密碼透過電子郵件寄給使用者，請重新執行此指令 (CTRL+C) 並傳遞 `--no-password` 旗標。',
        'ask_password_help' => '密碼長度至少需 8 個字元，且包含至少一個大寫字母和數字。',
        '2fa_help_text' => [
            '如果已啟用，此指令將停用使用者帳戶的兩步驟驗證。只有在使用者被鎖定帳戶時，才應將此指令用作帳戶復原指令。',
            '如果這不是您想做的，請按 CTRL+C 結束此程序。',
        ],
        '2fa_disabled' => '已為 :email 停用兩步驟驗證。',
    ],
    'schedule' => [
        'output_line' => '正在分派 `:schedule` (:hash) 中的第一個任務的工作。',
    ],
    'maintenance' => [
    ...
    'server' => [
        ...
        'power' => [
            'confirm' => '您即將對 :count 台伺服器執行 :action。您要繼續嗎？',
