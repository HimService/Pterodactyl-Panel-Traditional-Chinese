...
@section('content-header')
    <h1>建立使用者<small>將新使用者新增至系統。</small></h1>
    <ol class="breadcrumb">
        ...
        <div class="col-md-6">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label for="name_first" class="control-label">用戶端名字</label>
                        <div>
                            <input type="text" autocomplete="off" name="name_first" value="{{ old('name_first') }}" class="form-control" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="name_last" class="control-label">用戶端姓氏</label>
                        <div>
            ...
            <div class="box">
                ...
                <div class="box-body">
                    <div class="alert alert-info">
                        <p>提供使用者密碼是可選的。新使用者電子郵件會提示使用者在首次登入時建立密碼。如果在此處提供密碼，您將需要尋找不同的方法將其提供給使用者。</p>
                    </div>
