    ...
    <div class="row">
            ...
            <div class="col-md-6">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="registered" class="control-label">用戶端名字</label>
                            <div>
                                <input type="text" name="name_first" value="{{ $user->name_first }}" class="form-control form-autocomplete-stop">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="registered" class="control-label">用戶端姓氏</label>
                            <div>
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group no-margin-bottom">
                            ...
                            <div>
                                ...
                                <p class="text-muted small">留空以保持此使用者的密碼不變。如果密碼已變更，使用者將不會收到任何通知。</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-xs-12">
            <div class="box box-danger">
                ...
                <div class="box-body">
                    <p class="no-margin">此帳戶必須沒有關聯的伺服器才能刪除。</p>
                </div>
                <div class="box-footer">
                    <form action="{{ route('admin.users.view', $user->id) }}" method="POST">
                        {!! csrf_field() !!}
