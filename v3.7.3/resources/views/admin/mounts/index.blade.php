...
@section('content-header')
    <h1>掛載點<small>設定和管理伺服器的額外掛載點。</small></h1>
    <ol class="breadcrumb">
        ...
        <div class="col-xs-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools">
                        <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#newMountModal">建立</button>
                    </div>
                </div>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <p class="text-muted small">用於將此掛載點與另一個掛載點分開的唯一名稱。</p>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <p class="text-muted small">掛載點在容器內是否為唯讀？</p>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <p class="text-muted small">使用者是否可以自行掛載？</p>
                            </div>
                        </div>
                    </div>
