...
@section('content-header')
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="{{ route('admin.mounts') }}">掛載點</a></li>
...
@section('content')
    <div class="row">
        ...
        <div class="col-sm-6">
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">環境</h3>

                    <div class="box-tools">
                        <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#addEggsModal">新增環境</button>
                    </div>
                </div>
            ...
            <div class="modal-content">
                <form action="{{ route('admin.mounts.eggs', $mount->id) }}" method="POST">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">新增環境</h4>
                    </div>

                    <div class="modal-body">
                        <div class="row">
                            <div class="form-group col-md-12">
                                <label for="pEggs">環境</label>
