...
@section('content-header')
    <h1>郵件設定<small>設定 Jexactyl 應如何處理傳送電子郵件。</small></h1>
    <ol class="breadcrumb">
            ...
            <div class="box box-info">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="alert alert-info no-margin-bottom">
                                    此介面僅限於使用 SMTP 作為郵件驅動程式的執行個體。請使用 <code>php artisan p:environment:mail</code> 指令更新您的電子郵件設定，或在您的環境檔案中設定 <code>MAIL_DRIVER=smtp</code>。
                                </div>
                            </div>
                        </div>
                    </div>
                @else
                    <form>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-muted small">連線至 SMTP 伺服器時要使用的使用者名稱。</p>
                                    </div>
                                </div>
                                <div class="form-group col-md-6">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-muted small">與 SMTP 使用者名稱搭配使用的密碼。留空以繼續使用現有密碼。若要將密碼設定為空值，請在欄位中輸入 <code>!e</code>。</p>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                        ...
                        {{ csrf_field() }}
                        <button type="button" id="saveButton" class="btn btn-default pull-right" style="margin-top: 10px; margin-left: 8px;">儲存</button>
                        <button type="button" id="testButton" class="btn btn-default pull-right" style="margin-top: 10px;">測試</button>
                    </form>
                @endif
            </div>
        </div>
        ...
        $(document).ready(function () {
            ...
            $('#saveButton').on('click', function () {
                saveSettings().done(function () {
                    swal({
                        title: '成功',
                        text: '郵件設定已成功更新，且佇列工作程式已重新啟動以套用這些變更。',
                        type: 'success'
                    });
                });
            });
