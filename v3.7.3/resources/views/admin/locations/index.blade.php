...
@section('content-header')
    <h1>地區<small>所有可以分配節點的地區，以便於分類。</small></h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('admin.index') }}">管理</a></li>
        <li class="active">地區</li>
    </ol>
@endsection
    ...
    <div class="col-xs-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">地區列表</h3>
                <div class="box-tools">
                    <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#newLocationModal">建立新的</button>
                </div>
            </div>
        ...
        <div class="modal-content">
            <form action="{{ route('admin.locations') }}" method="POST">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">建立地區</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <label for="pShortModal" class="form-label">短代碼</label>
                            <input type="text" name="short" id="pShortModal" class="form-control" />
                            <p class="text-muted small">用於區分此地區與其他地區的簡短識別碼。長度必須介於 1 到 60 個字元之間，例如 <code>us.nyc.lvl3</code>。</p>
                        </div>
                        <div class="col-md-12">
                            <label for="pLongModal" class="form-label">描述</label>
                            <textarea name="long" id="pLongModal" class="form-control" rows="4"></textarea>
                            <p class="text-muted small">此地區的較長描述。長度必須小於 191 個字元。</p>
                        </div>
                    </div>
                </div>
