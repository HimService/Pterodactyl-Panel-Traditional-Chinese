        ...
        <div class="col-sm-6">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label for="pDescription" class="form-label">說明</label>
                    ...
                    <div class="form-group">
                        <label class="form-label">可透過 Jexactyl 商店部署</label>
                        <div>
                            <div class="radio radio-success radio-inline">
                                <input type="radio" id="pDeployableTrue" value="1" name="deployable" checked>
                                <label for="pDeployableTrue"> 允許 </label>
                            </div>
                            <div class="radio radio-danger radio-inline">
                                <input type="radio" id="pDeployableFalse" value="0" name="deployable">
                                <label for="pDeployableFalse"> 拒絕 </label>
                            </div>
                        </div>
                        <p class="text-muted"><small>
                            此選項可讓您控制此節點是否透過 Jexactyl 商店的伺服器建立頁面可見。
                            如果設定為停用，使用者將無法在此節點上部署。
                        </small></p>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="pDeployFee" class="form-label">商店部署費用</label>
                        <input type="text" name="deploy_fee" id="pDeployFee" class="form-control" value="{{ old('deploy_fee') ?? 0 }}"/>
                        <p class="text-muted small">在此處輸入值表示透過商店部署伺服器的使用者必須支付點數費用才能部署到此節點。</p>
                    </div>
                    <div class="form-group">
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <p class="text-muted small">輸入應儲存伺服器檔案的目錄。<strong>如果您使用 OVH，則應檢查您的分割區配置。您可能需要使用 <code>/home/daemon-data</code> 才能有足夠的空間。</strong></p>
                        </div>
                        <div class="form-group col-md-6">
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            <label for="pDisk" class="form-label">總硬碟空間</label>
                            <div class="input-group">
                        ...
                        <div class="form-group col-md-6">
                            <label for="pDiskOverallocate" class="form-label">硬碟超額分配</label>
                            <div class="input-group">
                        ...
                        <div class="col-md-12">
                            <p class="text-muted small">輸入可用於新伺服器的總硬碟空間量。如果您想允許硬碟空間超額分配，請輸入您要允許的百分比。若要停用超額分配檢查，請在欄位中輸入 <code>-1</code>。輸入 <code>0</code> 將防止在節點超出限制時建立新伺服器。</p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-md-6">
                        ...
                        <div class="col-md-12">
                            <p class="text-muted small">守護程序執行自己的 SFTP 管理容器，不使用主實體伺服器上的 SSHd 程序。<Strong>請勿使用您為實體伺服器的 SSH 程序指派的相同連接埠。</strong>如果您將在 CloudFlare&reg; 之後執行守護程序，則應將守護程序連接埠設定為 <code>8443</code> 以允許透過 SSL 進行 websocket 代理。</p>
                        </div>
                    </div>
                </div>
