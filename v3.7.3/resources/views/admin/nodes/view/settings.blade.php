    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="box">
                ...
                <div class="box-body row">
                    ...
                    <div class="form-group col-xs-12">
                        <label for="deploy_fee" class="control-label">商店部署費用</label>
                        <div>
                            <input type="text" autocomplete="off" name="deploy_fee" class="form-control" value="{{ old('deploy_fee', $node->deploy_fee) }}" />
                        </div>
                        <p class="text-muted"><small>在此處輸入值表示透過商店部署伺服器的使用者必須支付點數費用才能部署到此節點。</small></p>
                    </div>
                    <div class="form-group col-xs-12">
                    ...
                    <div class="form-group col-xs-12">
                        ...
                        <p class="text-muted small">如果節點標示為「維護中」，使用者將無法存取此節點上的伺服器。</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="box">
                ...
                <div class="box-body row">
                    ...
                    <div class="col-xs-12">
                        <div class="row">
                            <div class="form-group col-xs-6">
                                <label for="disk" class="control-label">硬碟空間</label>
                                <div class="input-group">
                        ...
                        <p class="text-muted small">輸入此節點上可用於伺服器分配的總硬碟空間量。您也可以提供一個百分比，以決定允許超出設定限制的硬碟空間量。</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-6">
            <div class="box">
                ...
                <div class="box-body row">
                    <div class="form-group col-xs-12">
                        <label for="deployable" class="control-label">適用於商店部署</label>
                        <div>
                            <div class="radio radio-success radio-inline">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body row">
                    <div class="form-group col-sm-6">
                        ...
                        <p class="text-muted"><small>重設守護程序主金鑰將使來自舊金鑰的任何請求失效。此金鑰用於守護程序上的所有敏感操作，包括伺服器建立和刪除。我們建議定期變更此金鑰以確保安全。</small></p>
                    </div>
                </div>
