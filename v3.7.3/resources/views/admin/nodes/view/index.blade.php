        ...
        <div class="row">
            ...
            <div class="col-xs-12">
                <div class="box box-danger">
                    ...
                    <div class="box-body">
                        <p class="no-margin">刪除節點是不可逆的操作，將立即從面板中移除此節點。必須沒有與此節點關聯的伺服器才能繼續。</p>
                    </div>
                    ...
                    <div class="col-sm-12">
                        <div class="info-box bg-orange">
                            ...
                            <div class="info-box-content" style="padding: 23px 10px 0;">
                                ...
                                <span class="info-box-number">維護</span>
                            </div>
                        </div>
                    </div>
                    @endif
                    <div class="col-sm-12">
                        <div class="info-box bg-{{ $stats['disk']['css'] }}">
                            ...
                            <div class="info-box-content" style="padding: 15px 10px 0;">
                                <span class="info-box-text">已分配硬碟空間</span>
