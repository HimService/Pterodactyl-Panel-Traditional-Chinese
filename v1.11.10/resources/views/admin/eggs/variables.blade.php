...
@section('title')
    核心 &rarr; {{ $egg->name }} &rarr; 變數
@endsection

@section('content-header')
    <h1>{{ $egg->name }}<small>管理此核心的變數。</small></h1>
    <ol class="breadcrumb">
                ...
                <form action="{{ route('admin.nests.egg.variables.edit', ['egg' => $egg->id, 'variable' => $variable->id]) }}" method="POST">
                    <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12">
                                <p class="text-muted small">此變數可在啟動指令中使用 <code>{{ $variable->env_variable }}</code> 存取。</p>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <p class="text-muted small">這些規則是使用標準的 <a href="https://laravel.com/docs/5.7/validation#available-validation-rules" target="_blank">Laravel 框架驗證規則</a>定義的。</p>
                        </div>
                    </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">建立新的核心變數</h4>
            </div>
            <form action="{{ route('admin.nests.egg.variables', $egg->id) }}" method="POST">
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12">
                            <p class="text-muted small">此變數可在啟動指令中輸入 <code>@{{environment variable value}}</code> 來存取。</p>
                        </div>
                    </div>
                    <div class="form-group">
