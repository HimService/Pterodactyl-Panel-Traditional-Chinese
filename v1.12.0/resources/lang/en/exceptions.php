...
return [
    'daemon_connection_failed' => '嘗試與 daemon 通訊時發生例外狀況，導致 HTTP/:code 回應碼。此例外狀況已被記錄。',
    'node' => [
    ...
    'nest' => [
        'delete_has_servers' => '無法從面板中刪除附加了作用中伺服器的 Nest。',
        'egg' => [
            'delete_has_servers' => '無法從面板中刪除附加了作用中伺服器的 Egg。',
            'invalid_copy_id' => '選取用於複製指令碼的 Egg 不存在，或正在複製指令碼本身。',
            'must_be_child' => '此 Egg 的「複製設定來源」指令必須是所選 Nest 的子選項。',
            'has_children' => '此 Egg 是一或多個其他 Egg 的父項。請先刪除那些 Egg，再刪除此 Egg。',
        ],
        'variables' => [
            'env_not_unique' => '環境變數 :name 對此 Egg 必須是唯一的。',
