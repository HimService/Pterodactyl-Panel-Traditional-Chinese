                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="pNestId" class="form-label">關聯核心區</label>
                                <div>
                                    ...
                                    <p class="text-muted small">將核心區想像成一個類別。您可以在一個核心區中放置多個核心，但請考慮在每個核心區中僅放置彼此相關的核心。</p>
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    ...
                                    <p class="text-muted small">屬於此核心的其他功能。對於配置其他面板修改很有用。</p>
                                </div>
                            </div>
                        </div>
                    </div>
