...
@section('content-header')
    <h1>掛載點<small>配置和管理伺服器的額外掛載點。</small></h1>
    <ol class="breadcrumb">
        ...
        <div class="col-xs-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">掛載點清單</h3>

                    <div class="box-tools">
                        <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#newMountModal">建立新掛載點</button>
                    </div>
                </div>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <p class="text-muted small">用於區分此掛載點與其他掛載點的唯一名稱。</p>
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <p class="text-muted small">此掛載點的較長描述，必須少於 191 個字元。</p>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <p class="text-muted small">掛載點在容器內可供存取的位置。</p>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <p class="text-muted small">容器內的掛載點是否為唯讀？</p>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <p class="text-muted small">使用者是否應該能夠自行掛載此掛載點？</p>
                            </div>
                        </div>
                    </div>
