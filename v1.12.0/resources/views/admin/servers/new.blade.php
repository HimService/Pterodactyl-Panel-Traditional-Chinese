        ...
        <div class="col-xs-12">
            <div class="box">
                ...
                <div class="box-body row">
                    ...
                    <div class="form-group col-sm-4">
                        <label for="pAllocation">預設端口分配</label>
                        <select id="pAllocation" name="allocation_id" class="form-control"></select>
                        <p class="small text-muted no-margin">將分配給此伺服器的主要 IP。</p>
                    </div>

                    <div class="form-group col-sm-4">
                        <label for="pAllocationAdditional">額外端口分配</label>
        ...
        <div class="col-xs-12">
            <div class="box">
                ...
                <div class="box-body row">
                    ...
                    <div class="form-group col-xs-6">
                        <label for="pThreads">CPU 核心綁定</label>
                ...
                <div class="box-body row">
                    <div class="form-group col-xs-6">
                        ...
                        <p class="text-muted small">如果伺服器使用的空間超過此數量，將不允許開機。如果伺服器在運行時超過此限制，它將被安全地停止並鎖定，直到有足夠的可用空間。設為 <code>0</code> 以允許無限的磁碟使用。</p>
                    </div>
