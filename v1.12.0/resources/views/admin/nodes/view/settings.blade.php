            ...
            <div class="box">
                ...
                <div class="box-body row">
                    ...
                    <div class="form-group col-xs-12">
                        ...
                        <p class="text-muted"><small>請輸入用於連接到 Wings 的網域名稱 (例如 <code>node.example.com</code>)。僅當您不為此節點使用 SSL 時，才可以使用 IP 位址。
                    ...
                    <div class="form-group col-xs-12">
                        ...
                        <p class="text-muted small">如果您在 Cloudflare 等代理之後執行 Wings，請選擇此項以讓 Wings 在啟動時跳過尋找憑證。</p>
                    </div>
                    <div class="form-group col-xs-12">
            ...
            <div class="box">
                ...
                <div class="box-body row">
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <p class="text-muted"><small>Wings 執行自己的 SFTP 管理容器，不使用主實體伺服器上的 SSHd 程序。<Strong>請勿使用您為實體伺服器的 SSH 程序指派的相同連接埠。</strong></small></p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="box box-primary">
                ...
                <div class="box-body row">
                    <div class="form-group col-sm-6">
                        ...
                        <p class="text-muted"><small>重設 Wings 主金鑰將使來自舊金鑰的任何請求失效。此金鑰用於 Wings 上的所有敏感操作，包括伺服器建立和刪除。我們建議定期更換此金鑰以確保安全。</small></p>
                    </div>
                </div>
