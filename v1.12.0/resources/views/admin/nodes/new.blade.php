            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <p class="text-muted small">請輸入用於連接到 Wings 的網域名稱 (例如 <code>node.example.com</code>)。<em>僅當</em>您不為此節點使用 SSL 時，才可以使用 IP 位址。</p>
                    </div>
                    <div class="form-group">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <p class="text-muted small">Wings 執行自己的 SFTP 管理容器，不使用主實體伺服器上的 SSHd 程序。<Strong>請勿使用您為實體伺服器的 SSH 程序指派的相同連接埠。</strong>如果您將在 CloudFlare&reg; 之後執行 Wings，您應將 Wings 連接埠設定為 <code>8443</code> 以允許透過 SSL 進行 websocket 代理。</p>
                        </div>
                    </div>
                </div>
