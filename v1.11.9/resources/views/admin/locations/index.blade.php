...
@section('content-header')
    <h1>地點<small>所有可以分配節點的地點，以便於分類。</small></h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('admin.index') }}">管理</a></li>
        <li class="active">地點</li>
    </ol>
@endsection
    ...
    <div class="col-xs-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">地點清單</h3>
                <div class="box-tools">
                    <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#newLocationModal">建立新地點</button>
                </div>
            </div>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <p class="text-muted small">此地點的詳細描述。長度必須小於 191 個字元。</p>
                        </div>
                    </div>
                </div>
