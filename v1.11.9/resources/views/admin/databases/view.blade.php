...
@section('content-header')
    <h1>{{ $host->name }}<small>檢視此資料庫主機的關聯資料庫和詳細資料。</small></h1>
    <ol class="breadcrumb">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <p class="text-muted small">所定義帳戶的密碼。留空以繼續使用指派的密碼。</p>
                    </div>
                    <hr />
